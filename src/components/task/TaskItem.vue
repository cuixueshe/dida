...
import { useTaskOperationMessage, useTaskRightContextMenu, isDark } from '@/composable'
...
<template>
  ...
  >
    ...
    />
    <div :class="['flex justify-start items-center gap-5px h-40px py-5px flex-1 pl-10px', isDark ? 'hover:bg-[#474747]/50' : 'hover:bg-[#ECF1FF]/50', taskStore.currentActiveTask?.id === task.id ?  isDark ? '!bg-[#474747]' : '!bg-[#ECF1FF]' : '']">
